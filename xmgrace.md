...
> b. in the new dialog, select data under "source" on the left side, check the "normalize" box   
> c. set the start and end point, and set the number of bins for the histogram  
> d. click "apply"  
> e. this will duplicate the original data. Hide the original data under "source" and select the new data under "destination"  
...
> b. if save as png, redo step 5 except choose "png"/"jpeg" instead of "PostScript" as the device. Then file > print
